...
[[ -z "$BASH_LINENO" || BASH_LINENO[0] -eq 0 ]] || (( ! SOURCE_GHWF_ENABLE_PRINT_BUFFERING_SH )) || return 0 || exit 0 # exit to avoid continue if the return can not be called

SOURCE_GHWF_ENABLE_PRINT_BUFFERING_SH=1 # including guard
